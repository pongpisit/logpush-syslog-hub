...
export function SettingsForm({ onSaved }: { onSaved: () => void }) {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault();
        saveSettings(apiBase, adminSecret);
        onSaved();
      }}
    >
      <h1 className="text-lg font-semibold text-tangerine">Logpush Syslog Hub</h1>
      <p className="text-sm text-slate-400">
        Connect to your deployed Worker to manage syslog destinations and CEF mappings.
      </p>
      <div>
        ...
        <input
          ...
          placeholder="https://logpush-syslog-hub.<account>.workers.dev"
          value={apiBase}
